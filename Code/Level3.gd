...
## Fase 3: A Sala do Trono (Boss Fight)
...
func _ready() -> void:
	...
	boss_style.bg_color = Color(0.8, 0.1, 0.1) # Vermelho
...
func show_victory() -> void:
	...
	t.timeout.connect(func(): get_tree().change_scene_to_file("res://Estoria/Ato1/Act1EndingCutscene.tscn"))
...
func spawn_heart() -> void:
	var h = Area2D.new()
	h.collision_layer = 0
	h.collision_mask = 2 # Detecta o player
